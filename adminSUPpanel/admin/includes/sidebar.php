                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="home.php?page=add-examinee">
                                ...
                                <li>
                                    <a href="home.php?page=add-examiner">
                                        <i class="metismenu-icon pe-7s-add-user">
                                        </i>Add Examiner
                                    </a>
                                </li>
                                <li>
                                    <a href="home.php?page=manage-examiner">
                                        <i class="metismenu-icon pe-7s-users">
                                        </i>Manage Examiner
                                    </a>
                                </li>
                                <li class="app-sidebar__heading">COURSE ENROLLMENT</li>
                                <li>
                                    <a href="home.php?page=assign-course">
                                        <i class="metismenu-icon pe-7s-add-user">
                                        </i>Assign Course
                                    </a>
                                </li>
                                <!-- <li>
                                    <a href="home.php?page=ressign-course">
                                        <i class="metismenu-icon pe-7s-users">
                                        </i>Remove Course
                                    </a>
                                </li> -->
