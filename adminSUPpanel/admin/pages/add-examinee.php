...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($gender == "0") {
        ...
        if ($selExamineeFullname->rowCount() > 0) {
            ...
            $insData = $conn->query("INSERT INTO examinee_tbl(exmne_fullname,exmne_gender,exmne_birthdate,exmne_year_level,exmne_email,exmne_password,exmne_roll) VALUES('$fullname','$gender','$bdate','$year_level','$email','$password','$roll')");
    ...
    header("Location: ../home.php?page=add-examinee");
...
<body>
<div id="modalForAddExaminee" style="margin: 0 auto; width: auto; max-width: calc(100% - 300px);">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input type="text" name="roll" id="roll" class="form-control" placeholder="Input Roll" autocomplete="off" required="">
          </div>
          <div class="form-group">
            <label>Email</label>
