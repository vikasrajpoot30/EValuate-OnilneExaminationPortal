...
-- Table structure for table `superadmin_acc`
--

CREATE TABLE `superadmin_acc` (
  `superadmin_id` int(11) NOT NULL,
  `superadmin_user` varchar(1000) NOT NULL,
  `superadmin_pass` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `superadmin_acc`
--

INSERT INTO `superadmin_acc` (`superadmin_id`, `superadmin_user`, `superadmin_pass`) VALUES
(1, 'superadmin@username', 'superadmin@password');
...
CREATE TABLE `course_assign` (
  ...
  `examinee_id` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `course_assign` (`course_id`, `examinee_id`) VALUES
('25', '5'),('26', '7');
