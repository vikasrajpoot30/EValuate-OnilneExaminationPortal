                    ...
                    <div class="card mb-3 widget-content bg-arielle-smile">
                        <div class="widget-content-wrapper text-white">
                            ...
                            <div class="widget-content-right">
                                <div class="widget-numbers text-white">
                                <?php
        $totalExams = $conn->query("SELECT count(ex_id) FROM exam_tbl where admin_id=$examin_id");
        $totalExamsValue = $totalExams->fetchColumn();
    ?>
    <span><?php echo $totalExamsValue; ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
