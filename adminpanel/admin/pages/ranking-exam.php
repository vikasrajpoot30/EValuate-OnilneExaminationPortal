            ...
            <?php 
                ...
                if($exam_id != "")
                {
                  // echo $exam_id;
                   ...
                   $selExmne = $conn->query("SELECT * FROM examinee_tbl et  WHERE exmne_roll in (select examinee_id from course_assign where course_id=$exam_course)");                  //  $selExmne = $conn->query("SELECT * FROM examinee_tbl et  WHERE exmne_course='$exam_course'  and
                  //   exmne_id in (select examne_id from exam_attempt)");
                        ...
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            ...
                            <tbody>
                              <?php 
                                ...
                                $selExam = $conn->query("SELECT * FROM exam_tbl where admin_id='$examin_id' ORDER BY ex_id DESC ");
