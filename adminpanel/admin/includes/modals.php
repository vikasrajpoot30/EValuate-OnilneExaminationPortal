     ...
     <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <div class="form-group">
            <label>Add Exam Date</label>
            <input type="date" name="examDate" class="form-control"> 
          </div>
          
          <div class="form-group">
            <label>Add Starting Time</label>
            <input type="time" name="examStartTime" class="form-control"> 
          </div>
          
          <div class="form-group">
            <label>Add Ending Time</label>
            <input type="time" name="examEndTime" class="form-control"> 
          </div>
